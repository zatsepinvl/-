package com.company.twooter.controller.rest;
...
import com.company.twooter.model.service.UserService;
...
public class UserController {
    ...
    private static final String REPEATING_USERNAME_ERROR_MESSAGE = "User with the same username already exists.";
    ...
    public ResponseEntity<ControllerError> createUser(@RequestBody User user) {
        if (userService.getUserByEmail(user.getEmail()) == null) {
            if (userService.getUserByEmail(user.getUsername()) == null) {
                ...
                return new ResponseEntity<>(new ControllerError(REPEATING_USERNAME_ERROR_MESSAGE), HttpStatus.BAD_REQUEST);
            }
        } else {
